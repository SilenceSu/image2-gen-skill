#!/usr/bin/env python3
"""Generate images from a text prompt through the router image generation API."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Call the text-to-image API and save returned images.")
    ...
    parser.add_argument(
        ...
        default="url",
        help="Requested response format.",
    )
    parser.add_argument("--extra-json", default="{}", help="JSON object merged into the request body.")
...
def get_model(args: argparse.Namespace, config: dict[str, Any]) -> str:
    ...
    return model
def check_args(args: argparse.Namespace, endpoint: str) -> None:
